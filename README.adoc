...
[source,sh]
----
java -jar target/xsdvi-1.2.jar UnitsML-v1.2-csd04.xsd -rootNodeName UnitsML
----

to render SVG for one element Quantity:
[source,sh]
----
java -jar target/xsdvi-1.2.jar UnitsML-v1.2-csd04.xsd -rootNodeName Quantity -oneNodeOnly
----

to render separate SVGs for each element:
[source,sh]
----
java -jar target/xsdvi-1.2.jar UnitsML-v1.2-csd04.xsd -rootNodeName all -oneNodeOnly -outputPath images/SVG
----
